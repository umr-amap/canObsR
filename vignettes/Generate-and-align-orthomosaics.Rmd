...
align_Mosa(path_in = file.path(my_path, '2_orthomosaics'),
        ...
        apply_matrix = TRUE,
        save_data = FALSE
) # Write aligned orthomosaics in 2_orthomosaics folder
