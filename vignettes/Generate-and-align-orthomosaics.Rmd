...
It is also possible to save the transform applied to an image, and to later apply it to another one, using the [`apply_saved_matrix()`](https://umr-amap.github.io/canObsR/reference/apply_saved_matrix.html) function.
