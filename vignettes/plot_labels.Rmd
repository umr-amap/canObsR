...
```{r}
plot_signal(data = merge_data, Genus = 'Desbordesia', slcted_id = 668)

```

```{r}
plot_signal(data = merge_data, Genus = 'Desbordesia', slcted_id = 668, Band = c('gli', 'gndvi'))

```

```{r}
plot_signal(data = merge_data, Genus = 'Desbordesia', Band = c('gli'), slcted_id = 668, show_Labels = TRUE)
