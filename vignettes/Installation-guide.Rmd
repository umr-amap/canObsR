...
<div style="padding:10px; background-color:#b5d0f5; border-left:5px solid #4682b4; font-size: 1.1em;">
...
The installation of canObsR involves several steps that go beyond a typical R package because the package acts as a bridge between different tools used for processing imagery. 
...
- Activate the licence (replace "AAAA-BBBB-CCCC-DDDD" with your license key):<br><br>
...
The conda environment you just created may contain incompatible arosics and gdal version.
You need arosics 1.12 and gdal 3.10. Run the following code to check the versions you have and if you have older versions, upgrade them.<br><br>
