...
arosics([AROSICS](https://github.com/GFZ/arosics)) and the Metashape python API. To guide you step by step into the workflow, you should download the test dataset (here) and follow the instructions [here](https://hugolblc.github.io/managecrownsdata/articles/generate_orthomosaics.html)
