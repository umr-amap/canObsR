...
Please download the exemple data at : ..., and extract it into "YOUR-PATH-TO-THE-TEST-DATA"

Our test data consists of a few drone images of the same zone taken at two different dates :

```{r echo=FALSE, fig.show='hold', message=FALSE, warning=FALSE, out.width='100%'}
knitr::include_graphics(file.path( system.file(package="managecrownsdata"), 'images/Capture1.JPG'))
```
...
```{r echo=FALSE, fig.show='hold', message=FALSE, warning=FALSE, out.width='100%'}
knitr::include_graphics(file.path( system.file(package="managecrownsdata"), 'images/Capture2.JPG'))
```
