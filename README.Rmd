...
================
  ...
  - [How to use canObs](#how-to-use-canObs)
...
To cite 'canObs', please use citation('canObs').
...
```{r, eval = FALSE}
library(devtools)
install_github("https://github.com/umr-amap/canObs.git")
```

# Documentation

In addition to the usual R package documentation, we also have extensive docs and examples [here](https://hugolblc.github.io/canObs/) 
...
```{r, eval = FALSE}
# Python env creation
env_name <- "canObs_env"   # use the name you want for your environment
environment = file.path( system.file(package="canObs"), 'PYTHON/environment.yaml')   # use the environment.yaml file included in the package
...
arosics([AROSICS](https://github.com/GFZ/arosics)) and the Metashape python API. To guide you step by step into the workflow, you should download the test dataset [here](https://zenodo.org/uploads/14748367?token=eyJhbGciOiJIUzUxMiJ9.eyJpZCI6ImVhNjBlZWM5LWYwZTEtNGUxNS04ZDRmLWI3MTAwZTdiMTdmNSIsImRhdGEiOnt9LCJyYW5kb20iOiIzYmViYTgxNWE2OGNlYTA1Zjc1YzdmMWUzZTdjZTVkMSJ9.pzx-dAnjJXNp34OIpqfibrHxZxSUSj8FvdLPGd6r4IaJSa5sAW-eme_EenQr0bLPUAjFGhKrZ-OqrVOQ7bLKBw) and follow the instructions [here](https://hugolblc.github.io/canObsR/articles/generate_orthomosaics.html).
