...
Our test data consists of a few drone images of the same zone taken at two different dates and the r functions `arosics()` and `Time_SIFT()` will be uses to make the orthomosaics.
