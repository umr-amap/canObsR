...
In order to facilitate your use of our package and ensure that you will not be lost when following the documentation, we strongly recommend you to following the data structure given below. To create this architecture we can use the function `create_files_architecture()`.
