...
arosics([AROSICS](https://github.com/GFZ/arosics)) and the Metashape python API. To guide you step by step into the workflow, you should download the test dataset (**here - add link**) and follow the instructions [here](https://hugolblc.github.io/managecrownsdata/articles/generate_orthomosaics.html)


Our test data consists of a few drone images of the same zone taken at two different dates and the r functions [`arosics()`](https://hugolblc.github.io/managecrownsdata/reference/arosics.html) and [`Time_SIFT()`](https://hugolblc.github.io/managecrownsdata/reference/Time_SIFT.html) will be used to generate the orthomosaics.
