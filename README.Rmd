...
In addition to the usual R package documentation, we also have extensive docs and examples at: https://hugolblc.github.io/managecrownsdata/
...
In order to facilitate your use of our package and ensure that you will not be lost when following the documentation, we strongly recommend you to following the data structure given below. To create this architecture you can use the function `create_files_architecture()`.

```{r echo=FALSE, fig.show='hold',fig.align="center",fig.cap="Recommended files organization", message=FALSE, warning=FALSE, out.width='40%'}
knitr::include_graphics("man/figures/files_architecture.jpg")
```
