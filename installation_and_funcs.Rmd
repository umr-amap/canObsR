...
#use_condaenv("D:/tulet/envs/pipeline")
```
...
image_write(image_read("test_data/outputs_TS/ORTHO_24p/20220427_ORTHO.tif"), path = "test_data/outputs_TS/ORTHO_24p/20220427_ORTHO.png", format = "png", quality=100)
image_write(image_read("test_data/outputs_TS/ORTHO_24p/20220511_ORTHO.tif"), path = "test_data/outputs_TS/ORTHO_24p/20220511_ORTHO.png", format = "png", quality=100)
```
...
arosics_in_r(path_in = "test_data/outputs_TS/ORTHO_24p",
