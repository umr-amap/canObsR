...
images <- c("test_data/my_drone_data/RGB_20220427/DJI_0070.JPG", "test_data/my_drone_data/RGB_20220427/DJI_0075.JPG", "test_data/my_drone_data/RGB_20220427/DJI_0080.JPG")
images_date2 <- c("test_data/my_drone_data/RGB_20220511/DJI_0278.JPG", "test_data/my_drone_data/RGB_20220511/DJI_0282.JPG", "test_data/my_drone_data/RGB_20220511/DJI_0287.JPG")
...
image_write(image_read("test_data/outputs_TS/ORTHO/Bouamir_20220427.tif"), path = "test_data/outputs_TS/ORTHO/Bouamir_20220427.png", format = "png", quality=100)
image_write(image_read("test_data/outputs_TS/ORTHO/Bouamir_20220511.tif"), path = "test_data/outputs_TS/ORTHO/Bouamir_20220511.png", format = "png", quality=100)
```

<h3>Resulting orthomosaics :</h3>
<div style="display: flex; justify-content: space-around;">
  <figure style="text-align: center;">
    <img src="test_data/outputs_TS/ORTHO/Bouamir_20220427.png" alt="Image 1" width="300" />
    <figcaption>Date 1</figcaption>
  </figure>
  <figure style="text-align: center;">
    <img src="test_data/outputs_TS/ORTHO/Bouamir_20220511.png" alt="Image 1" width="300" />
